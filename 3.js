...
const dayNumber = Number.parseInt(prompt("От 1 до 31 включительно: "));

if (dayNumber > 0 && dayNumber < 32) {
  const decadeMonth = Math.ceil(dayNumber / 10);
  console.log(`Число ${dayNumber} попадает в ${decadeMonth} декаду месяца.`);
} else {
